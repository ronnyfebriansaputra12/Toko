...
@section('container')
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" action="/barang" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                    <div class="form-floating">
                        <input type="text" name="kode_brg" class="form-control @error('kode_brg') is-invalid @enderror"
                            id="kode_brg" placeholder="Kode Barang" value="{{ old('kode_brg') }}" autofocus>
                        @error('kode_brg')
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="nama_brg" class="form-control @error('nama_brg') is-invalid @enderror""
                            id="nama_brg" placeholder="Nama Barang" value="{{ old('nama_brg') }}" autofocus>
                        @error('nama_brg')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-md-2">
                    <div class="form-floating">
                        <input type="number" name="stok_brg" class="form-control @error('stok_brg') is-invalid @enderror" value="{{ old('stok_brg') }}" id="stok_brg" placeholder="Kode Barang">
                        @error('stok_brg')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-md-10">
                    <div class="form-floating">
                        <input type="number" name="harga_brg" class="form-control @error('harga_brg') is-invalid @enderror" id="harga_brg" value="{{ old('harga_brg') }}" autofocus placeholder="Harga Barang">
                        @error('harga_brg')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
